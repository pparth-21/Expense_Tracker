...
class GroceriesExpScreen extends StatefulWidget {
  const GroceriesExpScreen({super.key});

  @override
  State<GroceriesExpScreen> createState() => _GroceriesExpScreenState();
}

String target = "Groceries";
List<Expense> food = exps.where((e) {
  return e.category.toLowerCase() == target.toLowerCase();
}).toList();

class _GroceriesExpScreenState extends State<GroceriesExpScreen> {
  @override
